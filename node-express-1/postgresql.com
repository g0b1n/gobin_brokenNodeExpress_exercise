...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-01-17T22:42:14.122441" />
  ...
  <link href="/media/css/fontawesome.css?7cecc4ac" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?7cecc4ac">

  <script src="/media/js/theme.js?7cecc4ac"></script>
      ...
      <div class="text">
        <ul>
            ...
            <li class=" non-badged">
              ...
              2024-03-14 &ndash; 2024-03-15 &middot; <a href="/about/event/pgday-paris-2024-2486/">pgDay Paris 2024</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/fossasia-pgday-2024-takes-place-in-hanoi-vietnam-on-april-9-2788/">FOSSASIA PGDay 2024 takes place in Hanoi, Vietnam on April 9</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-17 by FOSSASIA</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/nordic-pgday-2024-schedule-announced-and-open-for-registration-2789/">Nordic PGDay 2024 - Schedule announced and open for registration</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-17 by Nordic PGDay</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_back-220-released-2776/">pg_back 2.2.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-15 by Nicolas Thauvin</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgconfdev-2024-cfp-closing-registration-open-2787/">PGConf.dev 2024 - CFP Closing &amp; Registration Open!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-11 by Slonik Events Canada</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_dumpbinary-v214-released-2784/">pg_dumpbinary v2.14 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-11 by Gilles Darold</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hS"> How to speed up COUNT(DISTINCT)</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;oded valin</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-17</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hT"> Troubleshooting Postgres in Kubernetes</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hQ"> Introducing a new community wiki page &quot;Operations cheat sheet&quot;</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Takayuki Tsunakawa</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-17</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hU"> Benchmarking Postgres Vector Search approaches: Pgvector vs Lantern</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hR"> Installing PL/Java on PostgreSQL 16 and Rocky Linux</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hP"> Optimizing PostgreSQL functions with preloaded libraries</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hans-Juergen Schoenig</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-16</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hO"> Postgres password encryption without leaking credentials</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Sehrope Sarkuni</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-16</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hN"> JSON in PostgreSQL: Revolutionizing Data Flexibility in Your Database</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Tristen Raab</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hM"> Waiting for PostgreSQL 17 – ALTER TABLE command to change generation ex</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?7cecc4ac"></script>
